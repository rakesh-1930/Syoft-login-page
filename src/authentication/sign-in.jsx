...
import { Box, Grid, FormControl, Input, Paper, Typography, Button } from '@material-ui/core';
    ...
    return (
        <Box className={classes.container}>
            ...
            <Paper className={classes.formInputContainer}>
                ...
                <Typography variant='subtitle1'>Dont't have an accout? <Link to={'/signUp'} className={classes.link}>sign Up</Link></Typography>
                <form ref={formData} >
                    ...
                    <Button onClick={() => handleSubmit()} variant='contained' className={classes.formButton}> Sign In</Button>
                </form>
                <Grid className={classes.textContainer}>
                    <Typography className={classes.iconText}>----- or Continue with ---- </Typography>
